...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo BASE_URL ?>assets/img/logo_header.svg" type="image/x-icon">

    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL ?>vendors/slick/slick.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL ?>vendors/slick/slick-theme.css" />
