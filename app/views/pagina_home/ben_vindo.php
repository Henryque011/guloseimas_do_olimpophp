    ...
    <article class="site">
        <div class="lado_a_lado">
            <div class="guloseimas">
                ...
                <a href="<?php echo BASE_URL; ?>galeria">Veja nossa galeria</a>
            </div>
            <div class="lado_a_lado_img">
                <?php foreach ($galeria as $foto): ?>
                    <div class="img_01">
                        <a href="<?php echo BASE_URL; ?>galeria"><img src="<?php echo BASE_URL . 'uploads/' . $foto['foto_galeria']; ?>" class="ben_vindo_img"
